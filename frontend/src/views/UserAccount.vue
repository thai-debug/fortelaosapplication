    ...
    <div class="col-md-12">
      <div class="nav-align-top">
        <ul class="nav nav-pills flex-column flex-md-row mb-6 gap-2 gap-lg-0">
          ...
          <li class="nav-item">
            <a class="nav-link waves-effect waves-light" href="#"><i class="icon-base ri ri-notification-4-line icon-sm me-1_5"></i>Notifications</a>
          </li>
          <li class="nav-item">
            <a class="nav-link waves-effect waves-light" href="#"><i class="icon-base ri ri-link-m icon-sm me-1_5"></i>Connections</a>
          </li>
        </ul>
      </div>
      <div class="card mb-6">
        ...
        <div class="card-body">
          <div class="d-flex align-items-start align-items-sm-center gap-6">
            <img :src="url + '/assets/img/avatars/1.png'" alt="user-avatar" class="d-block w-px-100 h-px-100 rounded" id="uploadedAvatar">
      ...
      <div class="card">
        ...
        <div class="card-body">
          <form id="formAccountDeactivation" onsubmit="return false">
            ...
            <button type="submit" class="btn btn-danger deactivate-account waves-effect waves-light" disabled="disabled">Deactivate Account</button>
          </form>
        </div>
      </div>
    </div>
